        ...
        <div className="max-w-[420px] mx-auto w-full">
          {validLocations.length === 0 ? (
            ...
            areaLocations.length === 0 ? (
              ...
              <div className="bg-white dark:bg-slate-900 overflow-hidden border-y border-slate-100 dark:border-slate-800">
                {areaLocations.map((loc, index) => (
                    <div key={loc?.id} className="border-b-2 border-slate-200 dark:border-slate-700 last:border-b-0">
            ...
            filteredLocations.length === 0 ? (
              ...
              <div className="bg-white dark:bg-slate-900 overflow-hidden border-y border-slate-100 dark:border-slate-800">
                {filteredLocations.map((loc, index) => (
                  <div key={loc?.id ?? index} className="border-b-2 border-slate-200 dark:border-slate-700 last:border-b-0">
              ...
              {displayGroups.map((area) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 py-3 px-4 border-b-2 border-slate-200 dark:border-slate-700 last:border-b-0 hover:bg-slate-50 dark:hover:bg-slate-800/50 active:bg-slate-100 dark:active:bg-slate-800 transition-colors text-left"
                  >
