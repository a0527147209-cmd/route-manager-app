              ...
              {displayGroups.map((area) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 py-3 px-4 border-b-2 border-slate-100 dark:border-slate-800 last:border-b-0 hover:bg-slate-50 dark:hover:bg-slate-800/50 active:bg-slate-100 dark:active:bg-slate-800 transition-colors text-left"
                  >
