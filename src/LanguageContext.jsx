...
const translations = {
  en: {
    ...
    grams: 'Grams',
    lbs: 'Lbs',
    mixedEstimate: 'Mixed (Estimate)',
    quartersStandard: 'Quarters (5.67g)',
    dimesWeight: 'Dimes (2.268g)',
    nickelsWeight: 'Nickels (5g)',
    apply: 'Apply',
  },
  he: {
    appTitle: 'המסלול שלי',
    ...
    bill5: '5',
    bill1: '1',
    weightScale: 'משקל מטבעות',
    grams: 'גרמים',
    lbs: 'פאונד',
    mixedEstimate: 'מעורב (הערכה)',
    quartersStandard: 'רבעים (5.67ג)',
    dimesWeight: 'דיימס (2.268ג)',
    nickelsWeight: 'ניקלים (5ג)',
    apply: 'החל',
  },
};
