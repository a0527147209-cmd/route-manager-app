            ...
            <div className="grid grid-cols-5 gap-1">
              {[50, 20, 10, 5, 1].map((billValue) => (
                <div key={billValue} className="flex flex-col items-center">
                  <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 mb-0.5">
                    {t(`bill${billValue}`)}
                  </span>
                  <div className="flex items-center gap-0.5">
                    <button
                      ...
                      className="w-6 h-6 rounded flex items-center justify-center text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-red-100 dark:hover:bg-red-900/30 disabled:opacity-25 disabled:cursor-not-allowed active:scale-90 transition-all"
                    ...
                    <button
                      onClick={() => updateBillCount(billValue, 1)}
                      className="w-6 h-6 rounded flex items-center justify-center text-sm font-bold text-slate-600 dark:text-slate-300 hover:bg-green-100 dark:hover:bg-green-900/30 active:scale-90 transition-all"
